...
MpRequest.prototype.getRequest = function() {
  // request, uploadFile, downloadFile
}

MpRequest.prototype.request = function(config) {
  if (!this.API.request) {
...
/* 
MpRequest.prototype.abort = function() {
  const requestor = this.requester
  requestor && requestor.abort && requestor.abort()
}
 */
Methods.forEach(method => {
  MpRequest.prototype[method] = function(url, data, config = {}) {
